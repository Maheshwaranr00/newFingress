...
test('Deselect the chosen option ',async()=>{
    await test.step('User ensures any of the option is selected from the select dropdown',async()=>{
        await expect(page.getByText('Banana').first()).toContainText("Banana ");
...
test('Deselect the chosen option by searching keyword',async()=>{
    await test.step('User ensures any of the option is selected from the select with search dropdown',async()=>{
        await expect(page.getByText('Orange Select with search')).toContainText(" Orange ");
...
test('search the unavailable option ',async()=>{
    await test.step('User ensures the select with search and decoration dropdown is available',async()=>{
        await expect(page.getByText('Select with search and decoration', { exact: true })).toContainText("Select with search and decoration ");
  console.log("Value is deselected and 'Select with search and decoration ' comment is visibled in placeholder");
    })
    await test.step('Use searches the unavailable keyword in the search box',async()=>{
        await page.getByText('Select with search and decoration', { exact: true }).click();
  await page.getByPlaceholder('Search...').clear();
...
test('Select the desired list of checkbox',async()=>{
    ...
    await test.step('User selects the multiple desired options from the checkbox available',async()=>{
    ...
    await test.step('User ensures the selected checkbox options must be displayed',async()=>{
...
test('deselect the desired checkboxes',async()=>{
    await test.step('User ensures the List box select option is available',async()=>{
    ...
    await test.step('User deselects the multiple desired options from the checkbox',async()=>{
...
test('Select the business values',async()=>{
    ...
    await test.step('User selects the desired business value by searching the keyword in the search box available',async()=>{
    ...
    await test.step('User ensures the selected business value is displayed under business code dropdown',async()=>{
        await expect(page.getByText('CNY Business code dropdown')).toContainText('CNY');
        console.log("specified option is selected");
    })
})
test('Change the business value',async()=>{
    await test.step('User ensures the selected business value is available under business code dropdown',async()=>{
        await expect(page.getByText('CNY Business code dropdown')).toContainText('CNY');
    console.log("selected options available to change that value");
    })
    await test.step('User change the desired business value by searching the keyword in the search box available',async()=>{
...
test('Check the unavailable value2',async()=>{
    ...
    await test.step('Use searches the unavailable keyword in the Business code dropdown search box',async()=>{
...
test('Select the dependent value',async()=>{
...
test('Change the dependent value',async()=>{
...
test('Check the unavailable value',async()=>{
...
test('Select the auto populate value',async()=>{
...
test('Change the auto populate value',async()=>{
...
test('Select the values from model dropdown',async()=>{
...
test('Change the selected value',async()=>{
    ...
    await test.step('User ensures the changed option should be displayed under Model dropdown',async()=>{
        await expect (page.locator('span').filter({ hasText: '803' }).nth(0)).toContainText('803');
        console.log("Changed value is selected");
    })
})
test('Move the options under Advanced select',async()=>{
...
test('Move back the options under Advanced select',async()=>{
